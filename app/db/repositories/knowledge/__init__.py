...
from app.db.repositories.knowledge.entity_repo import KBEntityRepository
from app.db.repositories.knowledge.knowledge_base_repo import KnowledgeBaseRepository
from app.db.repositories.knowledge.module_repo import KBModuleRepository
from app.db.repositories.knowledge.narrative_repo import KBNarrativeRepository
